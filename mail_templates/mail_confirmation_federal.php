...
<div class="container">
    ...
    <div class="section">
        ...
        <p>Para registrar otro inmueble federal en la CDMX, entra <a href="http://www.preparados.gob.mx/macrosimulacro/federal.php">aquí</a>.</p>
    </div>
    <div class="divider"></div>
    <div class="section">
        <p>Tu correo electrónico será usado para futuro seguimiento, mantente pendiente a próximos anuncios.</p>
